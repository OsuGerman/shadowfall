...
>
> **Quelle der Lines:** [VELGRAD_VOICE_LINES_POOL_EN.md](VELGRAD_VOICE_LINES_POOL_EN.md) (Englisch, Active)
> + [VELGRAD_VOICE_LINES_POOL.md](VELGRAD_VOICE_LINES_POOL.md) (Deutsch, Lore-Quelle)
> + [VELGRAD_LORE_BIBEL.md](VELGRAD_LORE_BIBEL.md) Teil 12.

---

## STATUS (Update #178, 2026-05-24): ENGLISCH AKTIV

> Re-Sync gegen den KI-Klang. Die deutschen Synth-Stimmen (Update #171 als Procedural-Only-Pivot deklariert wegen „klingt viel zu sehr nach KI") sind durch eine englische Re-Generation mit denselben Premade-Voices ersetzt. Premade-Voices sind nativ englisch — englischer Text klingt deutlich natuerlicher.
>
> - **Pool-Quelle:** [VELGRAD_VOICE_LINES_POOL_EN.md](VELGRAD_VOICE_LINES_POOL_EN.md) (227 Lines, ~10.4k Chars)
> - **Modell:** `eleven_multilingual_v2` (englisch nativ)
> - **Backup:** Alte deutsche MP3s liegen unter `Sounds/voice_de_legacy/` (nicht im Spiel-Pfad referenziert)
> - **Casting-Tabelle unten:** Voice-IDs unveraendert — dieselben Premade-Voices wie zuvor, nur jetzt mit englischem Text.

Alle Voice-IDs unten sind **ElevenLabs Premade-Voices** (stabile, account-unabhaengige IDs).
Sie sind primaer englisch — was der ganze Punkt des EN-Switches ist:
