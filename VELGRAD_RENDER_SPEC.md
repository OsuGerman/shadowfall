...
> **Begleit-Docs:** [VELGRAD_SPRITE_BIBEL.md](VELGRAD_SPRITE_BIBEL.md), [VELGRAD_WORKFLOWS_BIBEL.md](VELGRAD_WORKFLOWS_BIBEL.md)
...
**Style-Anker:** Master-Style (POE2 Dark Fantasy painterly) + Lore-Beschreibung aus VELGRAD_BESTIARIUM.md
...
│   └─ VELGRAD_SPRITE_BIBEL.md (Targets + Prompts)
│   └─ VELGRAD_BESTIARIUM.md (Mob-Lore)
│   └─ VELGRAD_ITEMS_UNIQUE_BIBEL.md (Item-Lore)
│
└─ WIE-ORCHESTRIERT — Multi-Inference-Workflows
    └─ VELGRAD_WORKFLOWS_BIBEL.md (Workflow-Tools)
```
